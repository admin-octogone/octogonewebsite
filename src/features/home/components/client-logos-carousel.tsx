    ...
    <div className="w-full bg-white py-8 overflow-hidden">
      <div className="container mx-auto px-4">
        <div className="text-center mb-6">
          <h3 className="text-lg font-medium text-gray-500">Ils nous font confiance</h3>
        </div>
        ...
        >
          ...
          <div className="flex space-x-12 items-center">
            {clientLogos.map((client) => (
              <div key={client.id} className="flex-shrink-0 h-16 w-32 flex items-center justify-center grayscale hover:grayscale-0 transition-all duration-300">
                <Image
                  src={client.logo}
                  alt={client.alt}
                  width={120}
          ...
          <div className="flex space-x-12 items-center">
            {clientLogos.map((client) => (
              <div key={`duplicate-${client.id}`} className="flex-shrink-0 h-16 w-32 flex items-center justify-center grayscale hover:grayscale-0 transition-all duration-300">
                <Image
                  src={client.logo}
                  alt={client.alt}
                  width={120}
